...
4. `## Submitted evidence capture` (ledger SHA-256, query values, row count, URL accounting, Confluence retrieval time, version, exact raw Markdown, SHA-256, marker count)
...
8. `## Approved Confluence action` (page ID, append marker, exact append Markdown, exact resulting Markdown)
