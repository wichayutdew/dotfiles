...
Core execution protocol for autonomous coding, planning, verification, and subagent operations.

## Guiding Principles

### 1. Grounding & Evidence
- **Grounding**: Always observe branch, `HEAD`, and `git status --short`. Preserve unrelated checkouts and changes.
- **Claims Taxonomy**:
...
- **Plannotator Gate Protocol**:
  ...
  - Never edit production code before Plannotator approval.
